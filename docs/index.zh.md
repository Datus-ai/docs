...
- 自动捕获[元数据](knowledge_base/metadata.md)、[语义模型](knowledge_base/semantic_model.zh.md)、[指标](knowledge_base/metrics.zh.md)、[Reference SQL](knowledge_base/reference_sql.zh.md)、文档和成功案例
- 支持人在回路的策划与迭代
